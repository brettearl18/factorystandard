...
exports.restoreFirestore = void 0;
 ...
 */
exports.restoreFirestore = functions
    .region("us-central1")
    .runWith({
    ...
    if (!inputUriPrefix || typeof inputUriPrefix !== "string") {
        throw new functions.https.HttpsError("invalid-argument", "inputUriPrefix is required");
    }
...
//# sourceMappingURL=restoreFirestore.js.map